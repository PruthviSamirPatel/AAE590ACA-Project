function Inter = intermediary_orbit_family(Earth, Parking, Target, t_coast)
...
ecc = 0.005;                 % nearly circular
a   = 1.1 * Target.a;        % user-chosen trial SMA
raan = Parking.raan;         % starts with parking RAAN
argp = Parking.argp;
