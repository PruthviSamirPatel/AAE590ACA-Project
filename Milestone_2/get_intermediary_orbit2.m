function Inter = get_intermediary_orbit2(Earth, Parking, Target, t_coast)
% operates in dimensional form
% Chooses an intermediary orbit with fixed inc and small e
...
endfunction Inter = get_intermediary_orbit(Earth, Parking, Target, t_coast)
% operates in dimensional form
